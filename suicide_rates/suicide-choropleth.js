...
var projection = d3.geoMercator().scale(5000).center(center).translate([width/2, height/2]);
...
d3.queue()
	.defer(d3.json, "./utah-counties.json")
	.defer(d3.csv, "./suicide-by-health-district.csv")
	.await(ready);